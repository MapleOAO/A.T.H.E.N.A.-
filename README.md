...
- 352 条关系：313 条已核验、39 条待核验；92 个资料来源。
- 172 条中文术语：119 条官方用字已核对、53 条工作译名待审。53 位英雄的中文名称均有国服目录依据。
- 搜索、筛选、一跳聚焦、全图缩放与平移、实体和关系详情、证据定位、术语搜索、收录进度、JSON 下载。
- 全部实现无第三方运行时依赖；46 项自动化测试。
- 98 项官方图像（53英雄头像、19剧情配图、2组织标志、24原作局部），图谱、列表、详情与图像目录共用；74项名称占位明确标记待补。每张图像保留出处、说明与展示范围。
- 新增“黑爪之治”时期；旧身份与加入、离开、获救等后续事件分开保存。
- 本轮修复连线重叠并增加可点击圆点；补读《新血》第四期，新增2条关系并补强招募证据；研究记录先查 [研究索引](docs/research/README.md)。
