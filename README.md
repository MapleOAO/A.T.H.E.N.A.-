...
- 105 条关系：58 条已核验、47 条待核验；13 个资料来源。
- 172 条中文术语：67 条官方用字已核对、105 条工作译名待审。53 位英雄的中文名称均有国服目录依据。
- 搜索、筛选、一跳聚焦、全图缩放与平移、实体和关系详情、证据定位、术语搜索、收录进度、JSON 下载。
- 全部实现无第三方运行时依赖；37 项自动化测试。
- 53 位英雄有官方头像，图谱、列表及详情共用；其他119项显示本站名称占位图并标记待补图。每张官方图像记录来源与权利说明。
