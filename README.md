...
- 326 条关系：286 条已核验、40 条待核验；89 个资料来源。
...
- 95 项官方图像（53英雄头像、19剧情配图、2组织标志、21原作局部），图谱、列表、详情与图像目录共用；77项名称占位明确标记待补。每张图像保留出处、说明与展示范围。
...
- `dist/preview.html`：单文件离线审阅版，内嵌数据、样式和原创脚本，下载后可直接在浏览器打开；21张原作局部已内嵌；其余官方外链图像需联网，失败时回退名称图标。
