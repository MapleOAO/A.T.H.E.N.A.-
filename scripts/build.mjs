...
import { loadExcerptAssets } from './assets.mjs';
...
await writeFile(new URL('dist/preview.html', root), standalone.replace('<script id="embedded-knowledge"', `<script id="embedded-images" type="application/json">${JSON.stringify(excerptAssets)}</script><script id="embedded-knowledge"`));
